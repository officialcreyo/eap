...
<div class="content mt-3">
    <div class="col-xl-12">
        <a class="btn btn-success" href="<?php echo "$url/app/?page=partner-add"; ?>">+ Create new partner</a>
        <div class="card" style="margin-top: 2%;">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-8">
                        <h4 class="card-title mb-0">Partner overview</h4>
                    </div>
                </div>
                <hr>
                <div>
                    <table id="table_id" class="table table-hover table-bordered dataTable no-footer display">
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                ?>
                                <tr ondblclick="window.location='<?php $memberid=$row['mem_id']; echo "$url/app/?page=partner-accounts-edit&accountid=$memberid"; ?>';">
