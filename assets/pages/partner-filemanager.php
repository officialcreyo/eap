    ...
    <div class="col-sm-12">
        ...
        <div class="user-area dropdown">
            ...
            <div class="user-menu dropdown-menu" x-placement="bottom-start" style="position: absolute;">
                <a class="nav-link" href="<?php echo "$actual_link&upload=1"; ?>"><i class="fa fa-upload"></i> Upload file</a>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form enctype="multipart/form-data" id="form" action="../assets/functions/mysql-functions.php?add-filemanager=1" method="POST">
                    ...
                    <input class="form-control-file" type="file" name="uploaded_file" id="uploaded_file">
                </form>
            </div>
        </div>
    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM fm_folder WHERE folderisinfolderid='$folderurl' AND deleted='0' ORDER BY foldername";
                            ...
                            $sql = "SELECT * FROM fm_files WHERE infolder='$folderurl' AND deleted='0' ORDER BY filename";
                            $result = mysqli_query($conn, $sql);
