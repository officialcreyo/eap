    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <?php           
                        $sql = "SELECT * FROM events WHERE deleted='0' AND finished='1' ORDER BY date DESC LIMIT 5";
                        $result = mysqli_query($conn, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "<span>No recent Event.</span>";
                        }
                    ?>
                <span class="float-right"><a href="./?page=events-all"><i class="fa fa-calendar"></i> Watch all events</a></span>
                </div>
            </div>
        </div>
    </div>
